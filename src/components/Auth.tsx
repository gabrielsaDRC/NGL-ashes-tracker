  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-sm w-full p-6 background-card-att bg-gray-with-oppacity /80 backdrop-blur-sm rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-white mb-6 text-center">Welcome to NGL Tracker</h2>
        
        <button
          onClick={handleDiscordSignIn}
          disabled={isLoading}
          className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
        >
          {isLoading ? (
